...
;;;
;;; See the flag #JJG
;;; Edited for outdated MindModeling ACT-R version 1.4 [r875]
...
(defun bl-inhibition-term (chunk)
  (let ((bl (get-module base-level-inhibition))
    ...
    (when (and bl (numberp reference) (bl-inhibition-enabled bl))
      (- (log-coerced (+ 1.0 (expt-coerced (/ (max .05 (ms->seconds (- (mp-time-ms) (* 1000.0 reference)))) (bl-inhibition-scale bl))
